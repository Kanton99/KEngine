...
#include "vk_types.h"
#include "../Vulkan_API/VkBootstrap/VkBootstrap.h"
#include "../Vulkan_API/fmt/include/fmt/core.h"
#include "vk_images.h"
...
void VulkanEngine::init_swapchain() {
	...
	rimg_allocinfo.requiredFlags = VkMemoryAllocateFlags(VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);

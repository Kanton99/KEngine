...
vk::Pipeline PipelineBuilder::buildPipeline(vk::Device device) {
  ...
  vk::PipelineDynamicStateCreateInfo dynamic_info{.dynamicStateCount = 2,
...
void PipelineBuilder::setShaders(vk::ShaderModule vertexShader,
...
void PipelineBuilder::setCullMode(vk::CullModeFlags cullMode,
